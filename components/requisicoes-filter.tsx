...
interface RequisicoesFilterProps {
  setores: any[]
}

export default function RequisicoesFilter({ setores }: RequisicoesFilterProps) {
  ...
  const updateFilters = (newFilters: Record<string, string>) => {
    ...
    router.push(`/requisicoes?${params.toString()}`)
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                placeholder="ID, solicitante ou setor..."
                value={busca}
